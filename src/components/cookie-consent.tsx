...
const copy: Record<string, Copy> = {
  ...
  ru: {
    ...
    desc: "Мы используем файлы cookie для улучшения работы сайта, анализа трафика и персонализации контента. Нажмите «Принять все», чтобы разрешить все файлы cookie.",
    ...
    categories: {
      essential: {
        ...
        desc: "Необходимы для базовой работы сайта. Не могут быть отключены.",
        tag: "Обязательно",
      },
      analytics: {
        title: "Аналитические cookie",
        desc: "Собирают анонимные данные о посещаемости и использовании сайта.",
      },
      marketing: {
