...
const inputClass =
  "w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-secondary placeholder:text-secondary/25 outline-none transition-all duration-200 focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/10";
    ...
    <main>
      ...
      <section className="relative flex min-h-[460px] items-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-0 pt-32 sm:px-6 lg:px-8">
          ...
          {/* Quick contact strip */}
          <div className="mt-10 flex flex-wrap gap-6 border-t border-white/10 bg-dark/40 px-6 py-5 backdrop-blur-sm">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {t.serviceTypes.items.map((title: string, i: number) => (
              <div
                key={i}
                className="group relative overflow-hidden rounded-xl bg-white p-6 ring-1 ring-gray-100 transition-all duration-300 hover:shadow-lg hover:ring-primary/15"
              >
                <div className="absolute left-0 top-0 h-full w-1 bg-gray-200 transition-colors duration-300 group-hover:bg-primary" />
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-secondary/5 text-secondary/35 transition-colors duration-300 group-hover:bg-primary/10 group-hover:text-primary">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-start gap-14 lg:grid-cols-5">
            ...
            <div className="lg:col-span-3">
              <div className="rounded-2xl bg-gray-50 p-8 ring-1 ring-gray-100 sm:p-10">
                {submitted ? (
