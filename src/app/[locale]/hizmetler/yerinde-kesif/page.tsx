        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {t.steps.items.map((step: { title: string; desc: string }, i: number) => (
              <div key={i} className="group relative overflow-hidden rounded-xl bg-white p-6 ring-1 ring-gray-100 transition-all duration-300 hover:shadow-lg hover:ring-gray-200 sm:p-8">
                <div className="absolute left-0 top-0 h-full w-1 bg-gray-200 transition-colors duration-300 group-hover:bg-primary" />
                <div className="flex items-start gap-5">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-secondary/5 text-secondary/35 transition-colors duration-300 group-hover:bg-primary/10 group-hover:text-primary">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[13px] leading-relaxed text-secondary/55">{step.desc}</p>
                  </div>
                </div>
              </div>
            ))}
