        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {t.components.items.map((item: { title: string; text: string }, i: number) => (
              <div
                key={item.title}
                className="group overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100 transition-all duration-300 hover:shadow-lg hover:ring-primary/15"
              >
                <div className="flex flex-col sm:flex-row">
                  <div className="flex shrink-0 items-center gap-4 border-b border-gray-100 bg-gray-50 px-6 py-5 sm:w-64 sm:flex-col sm:items-start sm:border-b-0 sm:border-r sm:py-6 md:w-72">
                    <span className="text-2xl font-black text-primary/15 sm:text-3xl">
            ...
            {t.advantages.items.map((adv: { title: string; text: string }, i: number) => (
              ...
              >
                ...
                <div className="flex items-start gap-4">
                  <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-primary/8 text-[11px] font-bold text-primary">
                    {i + 1}
                  </span>
                  <div>
