      ...
      <section className="relative flex min-h-[420px] items-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-14 pt-32 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <span className="rounded-full bg-white/[0.06] px-4 py-2 text-[13px] font-semibold text-white/60 ring-1 ring-white/[0.08] backdrop-blur-sm">
          ...
          <div className="flex items-center gap-4 py-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-4 text-sm text-secondary outline-none transition-all duration-200 placeholder:text-secondary/25 focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/10"
              />
            </div>
            {search && (
              <button
                type="button"
                onClick={() => setSearch("")}
                className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3.5 py-2.5 text-xs font-medium text-secondary/60 transition-all hover:border-primary/30 hover:text-primary"
              >
            ...
            <span className="hidden whitespace-nowrap rounded-lg bg-secondary/5 px-3 py-1.5 text-xs font-semibold text-secondary/50 sm:inline-block">
            ...
            <div className="grid gap-x-6 gap-y-8 sm:grid-cols-2 lg:grid-cols-3">
              {filtered.map((item, i) => {
                ...
                return (
                  <div
                    key={`${item.name}-${i}`}
                    className="group flex flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-gray-100 transition-all duration-300 hover:ring-gray-200 hover:shadow-lg"
                  >
                    {/* Image */}
                    ...
                    {/* Content */}
                    <div className="flex flex-1 flex-col border-t border-gray-50 px-6 py-5">
                      ...
                      <div className="mt-auto pt-5">
                        <Link
                          ...
                          className="inline-flex items-center gap-1.5 text-xs font-semibold text-secondary/40 transition-colors duration-200 hover:text-primary"
                        >
                          {s.getQuote}
