    ...
    <main>
      ...
      <section className="relative flex min-h-[520px] items-end overflow-hidden">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-dark via-dark/75 to-dark/20" />
          ...
          <div className="flex flex-wrap gap-3 border-t border-white/10 py-6">
            {t.pills.map(
              (pill: string) => (
                <span
                  key={pill}
                  className="rounded-full bg-white/[0.06] px-4 py-2 text-[11px] font-semibold text-white/60 ring-1 ring-white/[0.08] backdrop-blur-sm"
                >
                  {pill}
                </span>
              )
      ...
      <section className="relative bg-white">
        <span
          className="pointer-events-none absolute right-0 top-0 select-none text-[28rem] font-black leading-none text-gray-50"
          aria-hidden="true"
        >
          01
        </span>
      ...
      <section className="relative bg-gray-50">
        <span
          className="pointer-events-none absolute left-0 top-0 select-none text-[28rem] font-black leading-none text-gray-100/60"
          aria-hidden="true"
        >
          02
        </span>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3">
                {t.dolphin.specs.map((spec: { label: string; value: string }) => (
                  <div key={spec.label} className="rounded-xl bg-white px-4 py-3 ring-1 ring-gray-100">
