        ...
        <div className="relative mx-auto max-w-7xl px-4 py-28 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-3">
            {t.scallop.subModels.map((model: string, i: number) => (
              <div
                key={model}
                className="group relative overflow-hidden rounded-xl bg-gray-50 px-5 py-4 ring-1 ring-gray-100 transition-all duration-300 hover:bg-white hover:shadow-md hover:ring-primary/20"
              >
