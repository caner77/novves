    ...
    <main>
      ...
      <section className="bg-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 rounded-xl bg-primary/5 px-6 py-4 ring-1 ring-primary/10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {t.products.map((product: { name: string; type: string; subModels: string[] }, i: number) => (
              ...
              >
                ...
                <span className="mb-4 block text-3xl font-black text-secondary/[0.06]">
                ...
                {product.subModels.length > 0 && (
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    {product.subModels.map((model: string) => (
                      <span
                        key={model}
                        className="rounded-md bg-white px-2.5 py-1 text-[11px] font-medium text-secondary/50 ring-1 ring-gray-100"
                      >
                        {model}
                      </span>
                    ))}
                ...
                <div className="mt-5 inline-flex items-center gap-1.5 rounded-md bg-secondary/5 px-3 py-1.5 text-[11px] font-semibold text-secondary/40">
