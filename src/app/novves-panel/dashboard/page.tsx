...
/* ═══════════════════════════════════════════════════════════
   Görsel Form Editörü — JSON yerine kullanıcı dostu alanlar
   ═══════════════════════════════════════════════════════════ */

/** Güzel alan adı üret: camelCase → "Camel Case" */
...
/* ═══════════════════════════════════════════════════════════
   NOVVES Admin Dashboard — Full CMS
   Tüm sözlük dosyalarını yönetir (10 dosya, 3 dil)
   ═══════════════════════════════════════════════════════════ */

/* ── Sayfa grupları ve bölümleri ── */
interface PageGroup {
  file: string;
  label: string;
  icon: string;
...
export default function DashboardPage() {
  ...
  /** Nested path ile form verisini güncelle: "endCard.title" veya "items[0].label" */
